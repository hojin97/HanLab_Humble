...
function Myodata_All_Processing(instrExercise,innumTrial,strcmap,strAAFTnum)
...
%         figname = sprintf('./resultFigs/%s/%s_C%s_trial(%d).png',strExercise,strExercise,strcmap, numTrial);
%     case 'AAFT5'
%         figname = sprintf('./resultFigs_AAFT(5)/%s/%s_C%s_trial(%d).png',strExercise,strExercise,strcmap, numTrial);
%     case 'AAFT10'
%         figname = sprintf('./resultFigs_AAFT(10)/%s/%s_C%s_trial(%d).png',strExercise,strExercise,strcmap, numTrial);
%     case 'AAFT20'
%         figname = sprintf('./resultFigs_AAFT(20)/%s/%s_C%s_trial(%d).png',strExercise,strExercise,strcmap, numTrial);
...
switch strAAFTnum
    case {'AAFT(0)','AAFT(2)','AAFT(3)','AAFT(4)','AAFT(5)','AAFT(10)','AAFT(20)'}
        %figname = sprintf('./resultFigs_%s/%s/%s_midAng_C%s_trial(%d).png',strAAFTnum,strExercise,strExercise,strcmap, numTrial);
        figname = sprintf('./resultFigs_color/%s/%s/%s_C%s_trial(%d).png',strAAFTnum,strExercise,strExercise,strcmap, numTrial);
    otherwise
        error('Wrong AAFT options');
end
