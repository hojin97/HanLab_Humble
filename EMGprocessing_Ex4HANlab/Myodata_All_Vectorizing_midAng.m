%----------------------------------------------------------\
% Myodata_All_Vectorizing_midAng.m
% Author : Han U. Yoon (2021/01/31)
% Purpose: To give some nice exprience to my commrade J.H. and H.J.
% Revise note: 
%----------------------------------------------------------\

function Myodata_All_Vectorizing_midAng(instrExercise,innumTrial,strcmap,strAAFTnum)
...
% switch strAAFTnum
%     case 'AAFT0'
%         filename2 = sprintf('./resultVecs/%s_midAng/%s_midAng_C%s_trial(%d).txt',strExercise,strExercise,strcmap, numTrial);
%     case 'AAFT5'
%         filename2 = sprintf('./resultVecs_AAFT(5)/%s_midAng/%s_midAng_C%s_trial(%d).txt',strExercise,strExercise,strcmap, numTrial);
%     case 'AAFT10'
%         filename2 = sprintf('./resultVecs_AAFT(10)/%s_midAng/%s_midAng_C%s_trial(%d).txt',strExercise,strExercise,strcmap, numTrial);
%     case 'AAFT20'
%         filename2 = sprintf('./resultVecs_AAFT(20)/%s_midAng/%s_midAng_C%s_trial(%d).txt',strExercise,strExercise,strcmap, numTrial);
%     otherwise
%         error('Wrong AAFT options');
% end
...
switch strAAFTnum
    case {'AAFT(0)','AAFT(2)','AAFT(3)','AAFT(4)','AAFT(5)','AAFT(10)','AAFT(20)'}
        filename2 = sprintf('./resultVecs_%s/%s_midAng/%s_midAng_C%s_trial(%d).txt',strAAFTnum,strExercise,strExercise,strcmap, numTrial);
    otherwise
        error('Wrong AAFT options');
end
...
% 
% % figname = sprintf('./resultFigs/%s_midAng/%s_midAng_C%s_trial(%d).png',strExercise,strExercise,strcmap, numTrial);
% % figname = sprintf('./resultFigs_AAFT(10)/%s_midAng/%s_midAng_C%s_trial(%d).png',strExercise,strExercise,strcmap, numTrial);
% % figname = sprintf('./resultFigs_AAFT(20)/%s_midAng/%s_midAng_C%s_trial(%d).png',strExercise,strExercise,strcmap, numTrial);
% 
% 
% % saveas(gcf,figname)
