...
hfig1 = visualize_sigDATA_colormap(sigDATAnormal,numCh,height,stretchFactor);
% figname = sprintf('./resultFigs/numModule%d_%s_orgEMG.fig',numModule,infile);
