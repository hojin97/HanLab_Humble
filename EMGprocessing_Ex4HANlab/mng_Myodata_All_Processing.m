...
ExerciseList = {'biceps', 'triceps', 'rvcurl', 'hammer'};
...
%             for i=1:2
            for i=1:K
               Myodata_All_Processing(strExercise,i,strcmap,strAAFTnum ); 
               Myodata_All_Processing_midAng(strExercise,i,strcmap,strAAFTnum ); 
            end        
        end
    end
end