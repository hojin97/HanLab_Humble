...
function Myodata_All_Processing_midAng(instrExercise,innumTrial,strcmap,strAAFTnum)
...
%     case 'AAFT5'
%         figname = sprintf('./resultFigs_AAFT(5)/%s_midAng/%s_midAng_C%s_trial(%d).png',strExercise,strExercise,strcmap, numTrial);
%     case 'AAFT10'
...
switch strAAFTnum
    case {'AAFT(0)','AAFT(2)','AAFT(3)','AAFT(4)','AAFT(5)','AAFT(10)','AAFT(20)'}
        %figname = sprintf('./resultFigs_%s/%s_midAng/%s_midAng_C%s_trial(%d).png',strAAFTnum,strExercise,strExercise,strcmap, numTrial);
        figname = sprintf('./resultFigs_color_midAng/%s/%s/%s_C%s_trial(%d).png',strAAFTnum,strExercise,strExercise,strcmap, numTrial);
    otherwise
        error('Wrong AAFT options');
end
